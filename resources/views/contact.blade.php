@extends('layouts.app')
@section('title', 'Liên Hệ - Mai Hoàng Store')
                ...
                <div class="p-5 space-y-5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">123 Nguyễn Thị Minh Khai, Q1, TP.HCM</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="tel:0948490070" class="text-sm text-[#ea4335] font-semibold hover:underline">0948 490 070</a>
                            <br>
                            <a href="tel:0973382111" class="text-sm text-gray-500 hover:text-[#ea4335]">0973 382 111</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="mailto:info@maihoang.vn" class="text-sm text-gray-500 hover:text-[#ea4335]">info@maihoang.vn</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
