...
<footer class="bg-[#1a1a2e] text-gray-300 mt-16">
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                <div class="flex items-center gap-2 mb-5">
                    ...
                    @else
                        ...
                        <div>
                            <span class="text-lg font-black text-white tracking-tight">Mai Hoàng</span>
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex items-start gap-3">
                        ...
                        <span class="text-gray-400">123 Nguyễn Thị Minh Khai, Q1, TP.HCM</span>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <a href="tel:0948490070" class="text-gray-400 hover:text-white transition">0948 490 070</a>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <a href="mailto:info@maihoang.vn" class="text-gray-400 hover:text-white transition">info@maihoang.vn</a>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    <li><a href="{{ route('about') }}" class="text-sm text-gray-400 hover:text-[#ea4335] transition">Giới thiệu Mai Hoàng</a></li>
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    <a href="#" class="w-9 h-9 bg-[#2d2d44] hover:bg-[#ea4335] transition rounded flex items-center justify-center">
    ...
    <div class="border-t border-[#2d2d44]">
        <div class="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-3">
            <p class="text-xs text-gray-500">© {{ date('Y') }} Mai Hoàng Store. All rights reserved.</p>
...
<div class="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
    <a href="tel:0948490070" class="w-12 h-12 bg-[#ea4335] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition animate-pulse">
