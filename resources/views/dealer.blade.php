@extends('layouts.app')
@section('title', 'Đăng Ký Đại Lý - ' . ($siteSettings['site_name'] ?? 'Mai Hoàng Store'))
@section('content')
                ...
                <div class="p-6 space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="tel:{{ preg_replace('/[^0-9]/', '', $siteSettings['contact_phone'] ?? '0948490070') }}" class="text-[#ea4335] font-bold text-lg">{{ $siteSettings['contact_phone'] ?? '0948 490 070' }}</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ $siteSettings['contact_email'] ?? 'dealer@maihoang.vn' }}" class="text-gray-600">{{ $siteSettings['contact_email'] ?? 'dealer@maihoang.vn' }}</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
